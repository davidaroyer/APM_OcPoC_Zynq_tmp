...
#define PWM_CHAN_COUNT 8
  ...
  #define RCOUT_ZYNQ_FILE_SIZE   0x200000
  #define RCOUT_ZYNQ_PWM_BASE	 0xFF200000
  #define RCOUT_ZYNQ_SHIFT       0x00040000
#else
  #define RCOUT_ZYNQ_FILE_SIZE   0x1000
  #define RCOUT_ZYNQ_PWM_BASE	 0x43c00000
  #define RCOUT_ZYNQ_SHIFT       0
#endif
...
void RCOutput_ZYNQ::init()
{
    ...
    sharedMem_cmd = (struct pwm_cmd *) (mmap(0, RCOUT_ZYNQ_FILE_SIZE, PROT_READ|PROT_WRITE, 
                                            MAP_SHARED, mem_fd, RCOUT_ZYNQ_PWM_BASE) + RCOUT_ZYNQ_SHIFT);
    close(mem_fd);
