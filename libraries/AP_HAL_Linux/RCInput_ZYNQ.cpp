...
#include "GPIO.h"
  ...
  #define RCIN_ZYNQ_FILE_SIZE 0x200000
  #define RCIN_ZYNQ_PULSE_INPUT_BASE  0xFF200000
  #define RCIN_ZYNQ_PWM_0_BASE1 0x00050000
#else
  #define RCIN_ZYNQ_FILE_SIZE 0x1000
  #define RCIN_ZYNQ_PULSE_INPUT_BASE  0x43c10000
  #define RCIN_ZYNQ_PWM_0_BASE1 0
#endif
...
void RCInput_ZYNQ::init()
{
    ...
    pulse_input = (volatile uint32_t*) mmap(0, RCIN_ZYNQ_FILE_SIZE, PROT_READ|PROT_WRITE,
...
void RCInput_ZYNQ::_timer_tick()
{
    ...
    while((v = *((uint32_t*)(pulse_input + RCIN_ZYNQ_PWM_0_BASE1))) != 0xffffffff) {
